    ...
    <form id="form1" runat="server">
        ...
        <!-- aqui é o timer, de 60 em 60 segundos ele ira atualizar a tabela -->
              ...
              <label style="position:fixed; top:50%; left:18%;" >  Temperatura </label>
                 <div id="grafico" style="height:0%; width:98.6%"> 
        ...
        <div id="myModal2">
	        <div class="modal-content" id="modal-tabela">
                ...
                <div id="corpo-trem">
                    <div id="menu-trem">
                        <label > Selecione o trem:</label>
                        <asp:DropDownList ID="dropvagao" runat="server" OnSelectedIndexChanged="dropvagao_SelectedIndexChanged"
                        AutoPostBack="true">       
                        </asp:DropDownList>
                    </div>
                    <div id="tabela-vagao">
