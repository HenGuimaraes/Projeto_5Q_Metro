...
<body> 
    <form runat="server">
        ...
        <div id="modalvagao" class="modal3">
            <div class="modal-cadastro">
                <span class="feichar">&times;</span>
                <div class="modalCadastro">
                <h1 align="center">Cadastro de trens</h1>
                <div id="divMae" >
               <div id="divao">
...
<%--        <div class="divex"> 
	    ...
	    <!--div e botões -->
            ...
            <img src="img/icone12.png" class="icone2" style="margin-left:12%">
            <button type="button" class="icone" id="myBtn3" >Cadastrar trens</button>
        </div>
        ...
        <script>
                    // pega o modal
                    var modal2 = document.getElementById('modalvagao');
